...
config = {'prefix': '&', 'developers': [], 'tba': {'team': '', 'application': '', 'version': ''}, 'discord_bot_invite_permission': 469791894, 'gmaps_key': "PUT GOOGLE MAPS API KEY HERE", 'discord_token': "Put Discord API Token here."}
